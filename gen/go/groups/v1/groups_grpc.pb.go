...
const (
	...
	GroupsService_ListGroups_FullMethodName  = "/groups.v1.GroupsService/ListGroups"
	GroupsService_UpdateGroup_FullMethodName = "/groups.v1.GroupsService/UpdateGroup"
	GroupsService_DeleteGroup_FullMethodName = "/groups.v1.GroupsService/DeleteGroup"
)
...
type GroupsServiceClient interface {
	...
	DeleteGroup(ctx context.Context, in *DeleteGroupRequest, opts ...grpc.CallOption) (*v1.SuccessResponse, error)
}
...
func (c *groupsServiceClient) DeleteGroup(ctx context.Context, in *DeleteGroupRequest, opts ...grpc.CallOption) (*v1.SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type GroupsServiceServer interface {
	...
	DeleteGroup(context.Context, *DeleteGroupRequest) (*v1.SuccessResponse, error)
}

// UnimplementedGroupsServiceServer should be embedded to have
...
func (UnimplementedGroupsServiceServer) DeleteGroup(context.Context, *DeleteGroupRequest) (*v1.SuccessResponse, error) {
