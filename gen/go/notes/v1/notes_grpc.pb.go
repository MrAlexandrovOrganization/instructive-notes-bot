...
const (
	...
	NotesService_AssignNoteToParticipant_FullMethodName = "/notes.v1.NotesService/AssignNoteToParticipant"
)
...
type NotesServiceClient interface {
	...
	DeleteNote(ctx context.Context, in *DeleteNoteRequest, opts ...grpc.CallOption) (*v1.SuccessResponse, error)
	AssignNoteToParticipant(ctx context.Context, in *AssignNoteToParticipantRequest, opts ...grpc.CallOption) (*Note, error)
}
...
func (c *notesServiceClient) UpdateNote(ctx context.Context, in *UpdateNoteRequest, opts ...grpc.CallOption) (*Note, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Note)
...
func (c *notesServiceClient) DeleteNote(ctx context.Context, in *DeleteNoteRequest, opts ...grpc.CallOption) (*v1.SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *notesServiceClient) AssignNoteToParticipant(ctx context.Context, in *AssignNoteToParticipantRequest, opts ...grpc.CallOption) (*Note, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Note)
	err := c.cc.Invoke(ctx, NotesService_AssignNoteToParticipant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotesServiceServer interface {
	...
	DeleteNote(context.Context, *DeleteNoteRequest) (*v1.SuccessResponse, error)
	AssignNoteToParticipant(context.Context, *AssignNoteToParticipantRequest) (*Note, error)
}

// UnimplementedNotesServiceServer should be embedded to have
...
func (UnimplementedNotesServiceServer) DeleteNote(context.Context, *DeleteNoteRequest) (*v1.SuccessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteNote not implemented")
}
func (UnimplementedNotesServiceServer) AssignNoteToParticipant(context.Context, *AssignNoteToParticipantRequest) (*Note, error) {
	return nil, status.Error(codes.Unimplemented, "method AssignNoteToParticipant not implemented")
}
...
func _NotesService_AssignNoteToParticipant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssignNoteToParticipantRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotesServiceServer).AssignNoteToParticipant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotesService_AssignNoteToParticipant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotesServiceServer).AssignNoteToParticipant(ctx, req.(*AssignNoteToParticipantRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NotesService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AssignNoteToParticipant",
			Handler:    _NotesService_AssignNoteToParticipant_Handler,
		},
	},
