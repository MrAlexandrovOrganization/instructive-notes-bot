...
const (
	...
	Role_ROLE_ORGANIZER   Role = 1
	Role_ROLE_CURATOR     Role = 2
	Role_ROLE_ADMIN       Role = 3
	Role_ROLE_ROOT        Role = 4
)
...
func (x *GetOrCreateUserRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type ListUsersRequest struct {
	...
	RoleFilter    Role                   `protobuf:"varint,2,opt,name=role_filter,json=roleFilter,proto3,enum=users.v1.Role" json:"role_filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AssignCuratorGroupRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *AssignCuratorGroupRequest) Reset() {
	*x = AssignCuratorGroupRequest{}
	mi := &file_users_v1_users_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AssignCuratorGroupRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AssignCuratorGroupRequest) ProtoMessage() {}

func (x *AssignCuratorGroupRequest) ProtoReflect() protoreflect.Message {
	mi := &file_users_v1_users_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AssignCuratorGroupRequest.ProtoReflect.Descriptor instead.
func (*AssignCuratorGroupRequest) Descriptor() ([]byte, []int) {
	return file_users_v1_users_proto_rawDescGZIP(), []int{8}
}

func (x *AssignCuratorGroupRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *AssignCuratorGroupRequest) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
const file_users_v1_users_proto_rawDesc = "" +
	"\n" +
	"\x14users/v1/users.proto\x12\busers.v1\x1a\x16common/v1/common.proto\"\xe4\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04role\x18\x05 \x01(\x0e2\x0e.users.v1.RoleR\x04role\x12\x19\n" +
	...
	"\x04user\x18\x01 \x01(\v2\x0e.users.v1.UserR\x04user\x12\x18\n" +
	...
	"pagination\x12/\n" +
	"\vrole_filter\x18\x02 \x01(\x0e2\x0e.users.v1.RoleR\n" +
	"roleFilter\"k\n" +
	"\x11ListUsersResponse\x12$\n" +
	"\x05users\x18\x01 \x03(\v2\x0e.users.v1.UserR\x05users\x120\n" +
	"\tpage_info\x18\x02 \x01(\v2\x13.common.v1.PageInfoR\bpageInfo\"K\n" +
	"\x15UpdateUserRoleRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\"\n" +
	"\x04role\x18\x02 \x01(\x0e2\x0e.users.v1.RoleR\x04role\"O\n" +
	"\x19AssignCuratorGroupRequest\x12\x17\n" +
	...
	"\x0eROLE_ORGANIZER\x10\x01\x12\x10\n" +
	"\fROLE_CURATOR\x10\x02\x12\x0e\n" +
	"\n" +
	"ROLE_ADMIN\x10\x03\x12\r\n" +
	"\tROLE_ROOT\x10\x042\x83\x04\n" +
	"\fUsersService\x12V\n" +
	"\x0fGetOrCreateUser\x12 .users.v1.GetOrCreateUserRequest\x1a!.users.v1.GetOrCreateUserResponse\x123\n" +
	"\aGetUser\x12\x18.users.v1.GetUserRequest\x1a\x0e.users.v1.User\x12K\n" +
	"\x13GetUserByTelegramID\x12$.users.v1.GetUserByTelegramIDRequest\x1a\x0e.users.v1.User\x12D\n" +
	"\tListUsers\x12\x1a.users.v1.ListUsersRequest\x1a\x1b.users.v1.ListUsersResponse\x12A\n" +
	"\x0eUpdateUserRole\x12\x1f.users.v1.UpdateUserRoleRequest\x1a\x0e.users.v1.User\x12I\n" +
	"\x12AssignCuratorGroup\x12#.users.v1.AssignCuratorGroupRequest\x1a\x0e.users.v1.User\x12E\n" +
	"\n" +
	"DeleteUser\x12\x1b.users.v1.DeleteUserRequest\x1a\x1a.common.v1.SuccessResponseBHZFgithub.com/mrralexandrov/instructive-notes-bot/gen/go/users/v1;usersv1b\x06proto3"
...
var file_users_v1_users_proto_goTypes = []any{
	...
	(*GetOrCreateUserRequest)(nil),     // 2: users.v1.GetOrCreateUserRequest
	(*GetOrCreateUserResponse)(nil),    // 3: users.v1.GetOrCreateUserResponse
	(*GetUserRequest)(nil),             // 4: users.v1.GetUserRequest
	(*GetUserByTelegramIDRequest)(nil), // 5: users.v1.GetUserByTelegramIDRequest
	(*ListUsersRequest)(nil),           // 6: users.v1.ListUsersRequest
	(*ListUsersResponse)(nil),          // 7: users.v1.ListUsersResponse
	(*UpdateUserRoleRequest)(nil),      // 8: users.v1.UpdateUserRoleRequest
	(*AssignCuratorGroupRequest)(nil),  // 9: users.v1.AssignCuratorGroupRequest
	...
	(*v1.SuccessResponse)(nil),         // 13: common.v1.SuccessResponse
}
var file_users_v1_users_proto_depIdxs = []int32{
	0,  // 0: users.v1.User.role:type_name -> users.v1.Role
	1,  // 1: users.v1.GetOrCreateUserResponse.user:type_name -> users.v1.User
	11, // 2: users.v1.ListUsersRequest.pagination:type_name -> common.v1.Pagination
	0,  // 3: users.v1.ListUsersRequest.role_filter:type_name -> users.v1.Role
	1,  // 4: users.v1.ListUsersResponse.users:type_name -> users.v1.User
	12, // 5: users.v1.ListUsersResponse.page_info:type_name -> common.v1.PageInfo
	0,  // 6: users.v1.UpdateUserRoleRequest.role:type_name -> users.v1.Role
	2,  // 7: users.v1.UsersService.GetOrCreateUser:input_type -> users.v1.GetOrCreateUserRequest
	4,  // 8: users.v1.UsersService.GetUser:input_type -> users.v1.GetUserRequest
	5,  // 9: users.v1.UsersService.GetUserByTelegramID:input_type -> users.v1.GetUserByTelegramIDRequest
	6,  // 10: users.v1.UsersService.ListUsers:input_type -> users.v1.ListUsersRequest
	8,  // 11: users.v1.UsersService.UpdateUserRole:input_type -> users.v1.UpdateUserRoleRequest
	9,  // 12: users.v1.UsersService.AssignCuratorGroup:input_type -> users.v1.AssignCuratorGroupRequest
	10, // 13: users.v1.UsersService.DeleteUser:input_type -> users.v1.DeleteUserRequest
	3,  // 14: users.v1.UsersService.GetOrCreateUser:output_type -> users.v1.GetOrCreateUserResponse
	1,  // 15: users.v1.UsersService.GetUser:output_type -> users.v1.User
	1,  // 16: users.v1.UsersService.GetUserByTelegramID:output_type -> users.v1.User
	7,  // 17: users.v1.UsersService.ListUsers:output_type -> users.v1.ListUsersResponse
	1,  // 18: users.v1.UsersService.UpdateUserRole:output_type -> users.v1.User
	1,  // 19: users.v1.UsersService.AssignCuratorGroup:output_type -> users.v1.User
	13, // 20: users.v1.UsersService.DeleteUser:output_type -> common.v1.SuccessResponse
