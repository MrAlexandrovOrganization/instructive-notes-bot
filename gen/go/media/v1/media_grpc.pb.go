...
type MediaServiceClient interface {
	...
	DeleteMedia(ctx context.Context, in *DeleteMediaRequest, opts ...grpc.CallOption) (*v1.SuccessResponse, error)
}
...
func (c *mediaServiceClient) DeleteMedia(ctx context.Context, in *DeleteMediaRequest, opts ...grpc.CallOption) (*v1.SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type MediaServiceServer interface {
	...
	DeleteMedia(context.Context, *DeleteMediaRequest) (*v1.SuccessResponse, error)
}
...
func (UnimplementedMediaServiceServer) DeleteMedia(context.Context, *DeleteMediaRequest) (*v1.SuccessResponse, error) {
